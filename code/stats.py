"""
Stats only version of original ACRe module
"""
...
from data.shapeworld import concept_to_lf, get_unique_concepts#, lf_to_concept
...
def anonymize(out):
    tok_names = string.ascii_lowercase + "".join(map(str, range(10))) # Implies max tokens = 36 for good analysis?
    out_anon = []
    for tok in out:
        i = int(tok)
        try:
